...
const changeModalState = state => {
  ...
  (0,_checkNumberInputs__WEBPACK_IMPORTED_MODULE_0__["default"])('#width');
  (0,_checkNumberInputs__WEBPACK_IMPORTED_MODULE_0__["default"])('#height');
          ...
          case "INPUT":
            if (item.getAttribute('type') === 'checkbox') {
              ...
              element.forEach((box, j) => {
                j == index ? box.checked = true : box.checked = false;
              });
            } else {
...
const forms = state => {
  ...
  (0,_checkNumberInputs__WEBPACK_IMPORTED_MODULE_0__["default"])('input[name="user_phone"]');
  const message = {
    loading: 'Loading...',
  ...
  function bindModal(triggerSelector, modalSelector, closerSelector, closeClickOverlay = true) {
    ...
    trigger.forEach(item => {
      item.addEventListener('click', e => {
        ...
        if ((!windowWidth.value || !windowHeight.value) && item.classList.contains('popup_calc_button')) {
          return;
        }

        // if window profile is not selected, do not open the next modal
        if (Array.from(windowProfile).every(checkbox => checkbox.checked !== true) && item.classList.contains('popup_calc_profile_button')) {
          return;
        }
        ;
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  (0,_modules_timer_js__WEBPACK_IMPORTED_MODULE_5__["default"])('.container1', deadline);
  (0,_modules_images_js__WEBPACK_IMPORTED_MODULE_6__["default"])();
});
})();
